...
import { products, productCatalogs } from '../../data/content';
        ...
        {activePdf && (
          ...
          >
            <motion.div
              ...
              className="relative flex flex-col w-full max-w-5xl h-[92vh] rounded-3xl bg-white shadow-card overflow-hidden"
            >
              <div className="flex items-center justify-between gap-3 px-5 py-3 border-b border-ink-100 bg-white">
                <div className="min-w-0">
                  <p className="text-[11px] uppercase tracking-widest text-ink-500">Product Catalog</p>
